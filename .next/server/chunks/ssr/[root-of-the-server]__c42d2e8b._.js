...
function ExportModule() {
    ...
    const handleExport = async ()=>{
        ...
        for(let i = 1; i <= pageCount; i++){
            ...
            doc.text(`Généré par ${settings.companyName} - Page ${i} sur ${pageCount}`, doc.internal.pageSize.getWidth() - 14, doc.internal.pageSize.getHeight() - 10, {
                align: 'right'
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c42d2e8b._.js.map